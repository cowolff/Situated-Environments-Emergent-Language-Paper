...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, state, action=None):
        ...
        if isinstance(self.action_space, MultiDiscrete):
            ...
            return action.T, logprob.sum(0), entropy.sum(0), self.critic(state)
            ...
            return action, logprob, entropy, self.critic(state)
            ...
            return actions, logprobs, entropies, self.critic(state)